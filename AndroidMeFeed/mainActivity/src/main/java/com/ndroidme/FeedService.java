...
//    }
    ...
    /*private void checkForNotifications() { 
    	...
    	mExecutor = new Timer(true);
    	mExecutor.scheduleAtFixedRate(timerTask, 0, FeedConfig.FM_SEARCH_INTERVAL);
    }*/
	...
	public void onCreate() {
		...
		if (notificationsValue) {
			...
			//mExecutor.scheduleAtFixedRate(mCheckForNotifications, FeedConfig.FM_SEARCH_DELAY, FeedConfig.FM_SEARCH_INTERVAL, TimeUnit.MILLISECONDS);
			TaskExecutor.repeatTask(mCheckForNotifications,FeedConfig.FM_SEARCH_INTERVAL);
		}
	}
